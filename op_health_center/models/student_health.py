...
class OpStudent(models.Model):
    _name = 'op.student'
    _inherit = ['op.student', 'op.health.profile.mixin']

    visit_ids = fields.One2many('op.health.visit', 'student_id', string='Health Visits')
    vaccination_ids = fields.One2many('op.health.vaccination', 'student_id', string='Vaccinations')
    checkup_ids = fields.One2many('op.health.checkup', 'student_id', string='Checkups')
